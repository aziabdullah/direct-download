	...
	rehabstudio.dc.init({
		...
		onPolite: function() {
			...
			*/
			...
			var dynCta = "Pelajari selengkapnya";
		    var dynCopy1 = "Pasang iklan di situs Anda<br>dengan AdSense";
		    var dynCopy2 = "Dapatkan penghasilan dari hobi Anda";
			/*
			...
			*/
			...
			rehabstudio.preloadImages(images, function(){
				...
				// create the dummy site container, this can change size to accomodate the site content and fill the bannscaleer.
				var site_container = rehabstudio.createElement({id: "site_container", backgroundColor: site.bgColor, scale:1.0, transformOrigin:"center center", overflow: "hidden", width: 1500, height: 800, left: 0, top: 0, retina: false, parent: banner});
					...
					var site_header = rehabstudio.createElement({id: "site_header", backgroundColor: site.headerColor, width: 1500, height: 60,  left: 0, top: 0, retina: false, parent: site_container});
					...
					var site_content = rehabstudio.createElement({id: "site_content", backgroundColor: site.bgColor, backgroundImage:"site_bg.gif", top: -35, width: 1000, height: 800, retina: false, parent: site_container});

						// make site content fit container horizontally
						site_content.centerHorizontal();


						var site_logo = rehabstudio.createElement({id: "site_logo", backgroundImage: "site_logo.png", left: 118, top: 42, retina: false, parent: site_content});
						...
						var side_bar = rehabstudio.createElement({id: "side_bar", backgroundImage: "side_bar.gif", left: 672, top: 170, retina: false, parent: site_content});
						...
						var site_pushdown_2 = rehabstudio.createElement({id: "site_pushdown_2", backgroundColor: colors.yellow, width: 230, height: 120, left: 674, top: 250, retina: false, parent: site_content});
						...
						// zoom out on site, prepare it for animation zoom
					 	TweenLite.set(site_container, {opacity:1.0, scale:0.4, x:-592, y:-310});

				//mask part o the site when zoomed in on the video
				var video_mask = rehabstudio.createElement({id: "video_mask", backgroundColor: "none" , opacity: 1, width: 100, height: 90, left: 184, bottom: 0, retina: false, parent: banner});
				...
				var copy_panel = rehabstudio.createElement({id: "copy_panel", backgroundColor: "#fff" , width: width, height: 90, left: 220, bottom: 0, retina: false, parent: banner});
					var txt_1 = rehabstudio.createElement({id: "txt_1", type:"p", className:"txt roboto regular", boxSizing: "border-box", padding: "0 30px", textAlign: "center", width: 367, left: 0, top: 24, parent: copy_panel});
				...
				var cta_panel = rehabstudio.createElement({id: "cta_panel", right: 0, backgroundColor: "#fff", bottom: 0, width: 142, height: 90, parent: banner});
					var logo_google_adsense = rehabstudio.createElement({id: "logo_google_adsense", type:"image", backgroundImage: "logo_google_adsense.png", right: 9, top: 19, retina: true, parent: cta_panel});

					var w = 126; // cta button width, the label will fit button width, and center text
					var cta_button = rehabstudio.createElement({id: "cta_button", backgroundColor: colors.blue, width: w, height: 38, right: 8, bottom: 6, borderRadius:2, retina: false, parent: cta_panel});
					var cta_button_label = rehabstudio.createElement({id: "cta_button_label", type:"p", className:"opensans semibold", width: w, height: 20, left: 0, top: 3, retina: false, parent: cta_button});
			...
			function doSiteAnimation (argument) {
				...
				site_container.zoom_in = new TimelineLite()
					.to(site_container, 1.2, {scale: 2.8, y: 410, x: -50, ease: ease.zoom});

				site_container.video_out = new TimelineLite()
					.to(video_mask, 0.1, {opacity: 0})
					.to(site_container, 0.5, {scale:0.22, x: -640, y: -312})

				site_container.reset = new TimelineLite()
					.to(site_container, 0.1, {scale:0.4, x:-592, y:-310, immediateRender: false})
					.to(video_poster, 0.1, {y: 0})
					.to(video_mask, 0.1, {opacity: 1})
			...
			function doEndframeAnimation (argument) {
				...
				endframe_panel.in = new TimelineLite()
					.to(endframe_panel, 0.01, {opacity: 1})
					.from(endframe_panel, 1, {x:0, width:220})
					.from(endframe_panel, 0.15, {y: 23, height: 30}, "-=1");
