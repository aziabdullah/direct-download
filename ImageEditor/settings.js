...
var VERSION = '2.0';
var WIDTH = Math.max(document.documentElement.clientWidth-136, window.innerWidth-136 || 0);				//canvas midth
var HEIGHT = Math.max(document.documentElement.clientHeight-158, window.innerHeight-158 || 0);				//canvas height
